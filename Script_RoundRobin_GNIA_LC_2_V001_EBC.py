...
for i in range(75,85,1):
    ...
    myString = "EBC_LC_2ffffff-"+str(i)
    mdb.Model(name=myString)
    myString_result = "EBC_LC_2ffffff"
    ...
    Create_Material_Isotropic(myString,"S355J0",210000.0,0.3,myY,7.85e-09)
    ...
    myRP1,myRP_Position1 = Create_Reference_Point(0.0,600.0,0.0,myString,"RP-1")
    ...
    Create_Analysis_Step(myString,"Step-2","Step-1",0.01,0.01,1E-15,300,ON)
    ...
    myPerturbation = i*Increment_Factor
    
    Create_CF_Load(myString,"RP-1","V","Step-1",UNSET,-4E+6*myPerturbation,UNSET)
    #Create_CF_Load(myString,"RP-1","V","Step-2",UNSET,-1.902E+07-(i*2.219E+06),UNSET)
    Create_CF_Load(myString,"RP-1","Q","Step-1",1.76E+6*myPerturbation,UNSET,UNSET)
    #Create_CF_Load(myString,"RP-1","Q","Step-2",1.32E+06+(i*1.54E+05),UNSET,UNSET)
    # Create Moment Loads
    
    Create_CF_Moment(myString,"RP-1","M","Step-1",UNSET,UNSET,-33E+9*myPerturbation)
    Create_CF_Moment(myString,"RP-1","T","Step-1",UNSET,22E+9*myPerturbation,UNSET)
    #Create_CF_Moment(myString,"RP-1","T","Step-2",UNSET,5.544E+09+(i*6.468E+08),UNSET)
    ...
    myPerturbation = myThickness_2*10
    
    #Create_Set_Vertice(2750.0, 9542.0-(myLength_2+myLength),0.0,myString,myFinalPart,"SPLA_Point")
    Create_Set_Vertice_2(2750.0, 9542.0-(myLength_2+myLength),0.0,myString,"Tower_Complete-1","SPLA_Point")
    #Create_Set_Vertice_2(2543.255278, 17.432E+03-(myLength_2+myLength),0.0,myString,"Tower_Complete-1","SPLA_Point")
    #Create_SPLA(myString,'Tower_Complete-1',"SPLA_Point","BC-Imperfection","Step-2",myPerturbation)
    #Create_Boundary_Condition_by_Instance(myString,'Tower_Complete-1',"SPLA_Point","BC-Imperfection","Step-2",-myPerturbation,UNSET,UNSET,UNSET,UNSET,UNSET)
    Create_Boundary_Condition_for_Assembly(myString,"SPLA_Point","SPDA-Imperfection","Step-2",-myPerturbation,UNSET,UNSET,UNSET,UNSET,UNSET)
    # Create Mesh
    ...
    CreateJob(myString,myString,myCPU)
    ...
    Open_ODB_and_Write_NodeSet_data_to_text(myString,"Step-2","U","SPLA_POINT",0)
    Open_ODB_and_Write_NodeSet_data_to_text(myString,"Step-2","RF","SPLA_POINT",0)
                                                                           
    Write_Variable_to_text(N,"Buckling Load")
    Write_Variable_to_text(P,"Perturbation Reaction Force")
    
    myPerturbation = [-40460000.0-(i*4624000.0)]
    ...
    for x in range(len(lastStep.frames)):
        ...
        center = odb.rootAssembly.nodeSets['SPLA_POINT']
